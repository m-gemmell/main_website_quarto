...
![](images/TAG.png){width=30% fig-align="center"}
...
__ELECTRIFIED__ weapon tag: Deals double DAMAGE to robots and other complex machines. Shorts out running electronics and briefly electrifies bodies of water. ([F:UE](https://claymorerpgs.itch.io/fist))
...
__RITUAL__ weapon tag: Shatters to protect you from death once, negating lethal damage. Disintegrates afterwards. ([F:UE](https://claymorerpgs.itch.io/fist))
